 ...
 */
public class CustRequestDialog extends javax.swing.JDialog {
     ...
     */
    public CustRequestDialog(java.awt.Frame parent, boolean modal, Vector v1, Vector v2) {
        super(parent, modal);
        initComponents();
        data1 = v1;
        data2 = v2;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustRequestDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CustRequestDialog dialog = new CustRequestDialog(new javax.swing.JFrame(), true, data1, data2);
