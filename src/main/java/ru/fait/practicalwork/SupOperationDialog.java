 ...
 */
public class SupOperationDialog extends javax.swing.JDialog {
     ...
     */
    public SupOperationDialog(java.awt.Frame parent, boolean modal, Vector out) {
        super(parent, modal);
        initComponents();
        preview = out;
        if (!preview.isEmpty()) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Код поставщика");
        ...
        jLabel5.setText("Код поставляемого товара 1");

        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel6.setText("Код поставляемого товара 2");
        ...
        jLabel7.setText("Код поставляемого товара 3");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SupOperationDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SupOperationDialog dialog = new SupOperationDialog(new javax.swing.JFrame(), true, preview);
